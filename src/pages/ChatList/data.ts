...
export const chats = [
    {
        ...
        lastMessage: {
            ...
            fromMe: false,
            preview:
                'Привет! А что там в итоге с макетами? А то заказчик уже...',
        },
    },
    {
        avatarUrl: '',
                ...
                messages: [
                    {
                        ...
                        direction: 'to',
                        text:
                            'Костик, доброе утро! Ты же уже проснулась? Хотел уточнить у тебя, каков статус с макетами))))',
                    },
                ],
            },
            {
                ...
                messages: [
                    {
                        ...
                        direction: 'to',
                        text:
                            'Привет! Костя, очень ждём макетов, скучаем сильно. Заказчик тебе привет передаёт, почему-то сказал, что горячий :)))',
                    },
                ],
            },
            {
                ...
                messages: [
                    {
                        ...
                        direction: 'to',
                        text:
                            'Привет! А что там в итоге с макетами? А то заказчик уже 1024-е сообщение тебе отправляет!',
                    },
                ],
            },
        ],
                ...
                messages: [
                    {
                        ...
                        direction: 'to',
                        text:
                            'Произошло нечто 😬Продолжение по ссылке! Которую мы кстати вам тут не предложим. Сорри!',
                    },
                ],
            },
        ],
        ...
        conversations: [
            {
                ...
                messages: [
                    ...
                    },
                    {
                        ...
                        direction: 'to',
                        text:
                            'Ну вообще да, на каждом апдейте валидировала, просто чтобы не сохранялась всякая дичь) а мы не сможем если возникла ошибка - просто не сохранять и ждать следующего апдейта?',
                    },
                    {
                        time: '01:44',
                        direction: 'from',
            ...
            },
            {
                ...
                messages: [
                    ...
                    },
                    {
                        ...
                        direction: 'to',
                        text:
                            'А фотки с Руной уже готовы? Оченб уже хочу посмотреть!!!',
                    },
                    {
                        time: '12:45',
                        direction: 'from',
