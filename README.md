...
Самостоятельный учебный проект, выполненный в рамках [Яндекс.Практикума](https://praktikum.yandex.ru/), трек "Мидл фронтенд-разработчик".

На данный момент свёрстаны шаблоны страниц, просмотр доступен здесь: https://pensive-leavitt-befdef.netlify.app/.
